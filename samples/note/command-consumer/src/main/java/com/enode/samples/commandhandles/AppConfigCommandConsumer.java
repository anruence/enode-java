...
//    }
    ...
    @Bean
    public DefaultProcessingCommandHandler defaultProcessingCommandHandler(DefaultEventService eventService) {
        return new DefaultProcessingCommandHandler(eventService);
    }
