...
object IOHelperAwait {
    ...
    internal class AsyncTaskExecutionContextMain<TAsyncResult>(private val actionName: String, asyncAction: Func<Deferred<TAsyncResult>>, private val mainAction: Action1<Int>, successAction: Action1<TAsyncResult>, contextInfoFunc: Func<String?>, failedAction: Action2<Throwable, String>?, retryTimes: Int, retryWhenFailed: Boolean, maxRetryTimes: Int, retryInterval: Int) {
        ...
        private fun doRetry() {
            currentRetryTimes++
            mainAction.apply(currentRetryTimes)
        }
