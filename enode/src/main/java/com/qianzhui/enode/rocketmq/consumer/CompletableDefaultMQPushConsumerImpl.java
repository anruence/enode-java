package com.qianzhui.enode.rocketmq.consumer;
...
public class CompletableDefaultMQPushConsumerImpl extends DefaultMQPushConsumerImpl {
    ...
    public CompletableDefaultMQPushConsumerImpl(CompletableDefaultMQPushConsumer defaultMQPushConsumer, RPCHook rpcHook) {
        super(defaultMQPushConsumer, rpcHook);
    ...
    public void pullMessage(final PullRequest pullRequest) {
        ...
        PullCallback pullCallback = new PullCallback() {
            ...
            public void onSuccess(PullResult pullResult) {
                if (pullResult != null) {
                    pullResult =
                            CompletableDefaultMQPushConsumerImpl.this.pullAPIWrapper.processPullResult(
                    ...
                    switch (pullResult.getPullStatus()) {
                        case FOUND:
                            ...
                            CompletableDefaultMQPushConsumerImpl.this.getConsumerStatsManager().incPullRT(
                            ...
                            if (pullResult.getMsgFoundList() == null || pullResult.getMsgFoundList().isEmpty()) {
                                ...
                                CompletableDefaultMQPushConsumerImpl.this.getConsumerStatsManager().incPullTPS(
                                        pullRequest.getConsumerGroup(), pullRequest.getMessageQueue().getTopic(),
                                        pullResult.getMsgFoundList().size());

                                boolean dispathToConsume = processQueue.putMessage(pullResult.getMsgFoundList());
                                CompletableDefaultMQPushConsumerImpl.this.consumeMessageService.submitConsumeRequest(//
                        ...
                        case NO_NEW_MSG:
                            ...
                            CompletableDefaultMQPushConsumerImpl.this.correctTagsOffset(pullRequest);
                        ...
                        case OFFSET_ILLEGAL:
                            ...
                            CompletableDefaultMQPushConsumerImpl.this.executeTaskLater(new Runnable() {

                                @Override
                                public void run() {
                                    try {
                                        CompletableDefaultMQPushConsumerImpl.this.offsetStore.updateOffset(
                                                pullRequest.getMessageQueue(), pullRequest.getNextOffset(), false);

                                        CompletableDefaultMQPushConsumerImpl.this.offsetStore.persist(pullRequest
                                                .getMessageQueue());

                                        CompletableDefaultMQPushConsumerImpl.this.rebalanceImpl
    ...
    private void checkConfig() throws MQClientException {
        ...
        boolean completableConcurrently = this.defaultMQPushConsumer.getMessageListener() instanceof CompletableMessageListenerConcurrently;
        if (!orderly && !concurrently && !completableConcurrently) {
            throw new MQClientException(
                    "messageListener must be instanceof MessageListenerOrderly or MessageListenerConcurrently or CompletableMessageListenerConcurrently" //
                            + FAQUrl.suggestTodo(FAQUrl.CLIENT_PARAMETER_CHECK_URL), //
                    null);
        }
