...
public class MysqlPublishedVersionStore extends AbstractVerticle implements IPublishedVersionStore {
    ...
    public MysqlPublishedVersionStore(DataSource dataSource, DBConfigurationSetting setting) {
    ...
    public CompletableFuture<Integer> updatePublishedVersionAsync(String processorName, String aggregateRootTypeName, String aggregateRootId, int publishedVersion) {
        ...
        return future.exceptionally(throwable -> {
            if (throwable instanceof SQLException) {
                ...
                if (isInsert && ex.getErrorCode() == duplicateCode && ex.getMessage().contains(uniqueIndexName)) {
                    return 0;
                }
